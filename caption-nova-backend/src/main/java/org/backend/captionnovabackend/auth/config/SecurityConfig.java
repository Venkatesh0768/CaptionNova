package org.backend.captionnovabackend.auth.config;

import lombok.RequiredArgsConstructor;
import org.backend.captionnovabackend.auth.security.JwtAuthenticationEntryPoint;
import org.backend.captionnovabackend.auth.security.JwtAuthenticationFilter;
import org.backend.captionnovabackend.auth.security.oauth2.CustomOAuth2UserService;
import org.backend.captionnovabackend.auth.security.oauth2.OAuth2AuthenticationFailureHandler;
import org.backend.captionnovabackend.auth.security.oauth2.OAuth2AuthenticationSuccessHandler;
